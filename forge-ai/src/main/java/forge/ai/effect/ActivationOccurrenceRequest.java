...
record ActivationOccurrenceRequest(int currentMana, int nextTurnMana, int manaCost, int lifeCost,
        int currentLife, int nextTurnLife, boolean hasTapCost, boolean sourceTapped, boolean canPayNow,
    ...
    static ActivationOccurrenceRequest unsupported(final String reason) {
        return new ActivationOccurrenceRequest(0, 0, 0, 0, 0, 0, false, false, false,
