...
public final class PlayerResourceValueEvaluator {
    ...
    public static final int MANA_VALUE = CardResourceValueEvaluator.MANA_VALUE;
     ...
     * an already-full hand. At three cards the value is 90, approximately three mana at 25 each.
     */
    public static int evaluateNextCard(final int currentHandSize) {
        return CardResourceValueEvaluator.evaluateNextCard(currentHandSize);
    }
    ...
    public static int evaluateMana(final int amount) {
        return CardResourceValueEvaluator.evaluateMana(amount);
    }

    /** Returns the castability-adjusted mana investment for a card with this printed mana value. */
    public static int evaluateManaInvestment(final int manaValue) {
        return CardResourceValueEvaluator.evaluateManaInvestment(manaValue);
    }
    ...
    public static int evaluateAverageCardPlay(final int manaCost) {
        return CardResourceValueEvaluator.evaluateAverageCardPlay(manaCost);
    }
