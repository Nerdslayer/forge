...
public enum AiProps {
    ...
    EFFECT_SYNERGY_WEIGHT ("100"),
    ENABLE_INTRINSIC_REMOVAL_ANALYSIS ("false"),
    INTRINSIC_REMOVAL_WEIGHT ("100"),
    ENABLE_TARGETED_DISCARD_ANALYSIS ("false"),
    ENABLE_OWN_DISCARD_VALUE_TIEBREAK ("false"),
    ENABLE_CAST_VALUE_TIEBREAK ("false"),
    ENABLE_ACTIVATION_VALUE_TIEBREAK ("false"),
    ENABLE_ACTION_COMBINATION_VALUE_SELECTION ("false"),
    ENABLE_ACTION_COMBINATION_VALUE_SHADOW ("false"),
    ENABLE_PLANESWALKER_LOYALTY_ACTION_SELECTION ("false"),
    ACTION_COMBINATION_VALUE_SELECTION_MIN_ADVANTAGE ("50"),
    ACTION_COMBINATION_VALUE_SELECTION_TIMEOUT_MS ("100"),
