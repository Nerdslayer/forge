...
public class StaticData {
    ...
    public StaticData(CardStorageReader cardReader, CardStorageReader customCardReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String cardArtPreference, boolean enableUnknownCards, boolean loadNonLegalCards) {
        this(cardReader, null, customCardReader, null, editionFolder, customEditionsFolder, blockDataFolder, "",
                cardArtPreference, "en-US", enableUnknownCards, loadNonLegalCards, false, false, null);
    }
    public StaticData(CardStorageReader cardReader, CardStorageReader tokenReader, CardStorageReader customCardReader, CardStorageReader customTokenReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String setLookupFolder, String cardArtPreference, boolean enableUnknownCards, boolean loadNonLegalCards, boolean allowCustomCardsInDecksConformance, boolean enableSmartCardArtSelection) {
        this(cardReader, tokenReader, customCardReader, customTokenReader, editionFolder, customEditionsFolder,
                ...
                allowCustomCardsInDecksConformance, enableSmartCardArtSelection, null);
    }
    public StaticData(CardStorageReader cardReader, CardStorageReader tokenReader, CardStorageReader customCardReader, CardStorageReader customTokenReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String setLookupFolder, String cardArtPreference, boolean enableUnknownCards, boolean loadNonLegalCards, boolean allowCustomCardsInDecksConformance, boolean enableSmartCardArtSelection, BiPredicate<String, String> preferredLanguageAvailability) {
        this(cardReader, tokenReader, customCardReader, customTokenReader, editionFolder, customEditionsFolder,
                blockDataFolder, setLookupFolder, cardArtPreference, "en-US", enableUnknownCards, loadNonLegalCards,
                allowCustomCardsInDecksConformance, enableSmartCardArtSelection, preferredLanguageAvailability);
    }
    public StaticData(CardStorageReader cardReader, CardStorageReader tokenReader, CardStorageReader customCardReader, CardStorageReader customTokenReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String setLookupFolder, String cardArtPreference, String preferredCardLanguage, boolean enableUnknownCards, boolean loadNonLegalCards, boolean allowCustomCardsInDecksConformance, boolean enableSmartCardArtSelection) {
        this(cardReader, tokenReader, customCardReader, customTokenReader, editionFolder, customEditionsFolder,
                blockDataFolder, setLookupFolder, cardArtPreference, preferredCardLanguage, enableUnknownCards,
                loadNonLegalCards, allowCustomCardsInDecksConformance, enableSmartCardArtSelection, null);
    }
    public StaticData(CardStorageReader cardReader, CardStorageReader tokenReader, CardStorageReader customCardReader, CardStorageReader customTokenReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String setLookupFolder, String cardArtPreference, String preferredCardLanguage, boolean enableUnknownCards, boolean loadNonLegalCards, boolean allowCustomCardsInDecksConformance, boolean enableSmartCardArtSelection, BiPredicate<String, String> preferredLanguageAvailability) {
